...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1 ">
            <!-- Dashboard -->
            <li class="menu-item">
              <a href="<?php echo site_url('admin/index')?>" class="menu-link">
            ...
            <!-- Tables -->
            <li class="menu-item">
              <a href="<?php echo site_url('admin/user_information')?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-user me-1"></i>
                <div data-i18n="Tables">User Information</div>
              </a>
            </li>
